        ...
        <div class="space-y-6">
            ...
            @forelse ($estudiante->clases as $clase)
                ...
                <div class="rounded-2xl border overflow-hidden" style="border-color: var(--guest-input-border);">
                    ...
                    {{-- Cabecera del curso --}}
                    <div class="px-5 py-4" style="background-color: var(--guest-input-bg);">
                        <div class="flex items-start justify-between gap-2">
                            ...
                            @if ($clase->catedratico)
                                <span class="shrink-0 text-xs px-2 py-1 rounded-full" style="background-color: var(--guest-card-bg); color: var(--guest-subtitle);">
