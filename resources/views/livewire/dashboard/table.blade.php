<div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl shadow p-5 flex items-start gap-3">
            <div class="bg-[#e6f6ff] rounded-lg p-2.5 flex-shrink-0">
                <span class="material-symbols-outlined text-[#000b60]" style="font-size:22px">class</span>
            </div>
            <div>
                <p class="text-2xl font-black text-[#000b60] leading-none">{{ $kpis['totalClases'] }}</p>
                <p class="text-xs text-gray-500 font-medium mt-1">Clases activas</p>
            </div>
        </div>

        <div class="bg-white rounded-xl shadow p-5 flex items-start gap-3">
            <div class="bg-[#e6f6ff] rounded-lg p-2.5 flex-shrink-0">
                <span class="material-symbols-outlined text-[#000b60]" style="font-size:22px">groups</span>
            </div>
            <div>
                <p class="text-2xl font-black text-[#000b60] leading-none">{{ $kpis['totalEstudiantes'] }}</p>
                <p class="text-xs text-gray-500 font-medium mt-1">Estudiantes únicos</p>
            </div>
        </div>

        <div class="bg-white rounded-xl shadow p-5 flex items-start gap-3">
            <div class="bg-[#e6f6ff] rounded-lg p-2.5 flex-shrink-0">
                <span class="material-symbols-outlined text-[#000b60]" style="font-size:22px">calendar_month</span>
            </div>
            <div>
                <p class="text-2xl font-black text-[#000b60] leading-none">{{ $kpis['sesionesMes'] }}</p>
                <p class="text-xs text-gray-500 font-medium mt-1">Sesiones este mes</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-5 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium mt-1">Asistencia promedio</p>
            </div>
        </div>
    ...
    {{-- Sin clases --}}
    @if($clases->isEmpty())
        <div class="bg-white rounded-xl shadow flex flex-col items-center justify-center py-20 text-gray-400">
    ...
    <div class="bg-white rounded-xl shadow p-4 mb-6 flex flex-wrap gap-4 items-end">
        ...
        <div class="flex-1 min-w-[200px]">
            <label class="block text-xs font-bold text-[#000b60] mb-1.5 uppercase tracking-wide">Clase</label>
        ...
        <div>
            <label class="block text-xs font-bold text-[#000b60] mb-1.5 uppercase tracking-wide">Período (sesiones)</label>
                    ...
                    <button wire:click="$set('periodo', '{{ $val }}')"
                            class="px-3 py-2 rounded-lg text-xs font-bold border transition
                                {{ $periodo === $val
                                    ...
                                    : 'bg-white text-[#000b60] border-gray-200 hover:bg-blue-50' }}">
                        {{ $lbl }}
                    </button>
                @endforeach
            </div>
        ...
        <div class="ml-auto text-right hidden md:block">
            <p class="text-xs text-gray-400 font-medium">Clase seleccionada</p>
            <p class="text-sm font-black text-[#000b60]">{{ $claseNombre }}</p>
            <p class="text-xs text-gray-400">{{ $totalEstClase }} estudiante(s)</p>
        </div>
        @endif
    ...
    <div wire:ignore>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-xl shadow p-5">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="font-black text-[#000b60] text-base leading-tight">Asistencia por sesión</h3>
                        <p class="text-xs text-gray-400 mt-0.5">Presentes vs. ausentes</p>
                    </div>
                    <span class="material-symbols-outlined text-[#000b60] opacity-20" style="font-size:28px">bar_chart</span>
                </div>
            ...
            <div class="bg-white rounded-xl shadow p-5">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="font-black text-[#000b60] text-base leading-tight">Asistencia por estudiante</h3>
                        <p class="text-xs text-gray-400 mt-0.5">% en el período seleccionado</p>
                    </div>
                    <span class="material-symbols-outlined text-[#000b60] opacity-20" style="font-size:28px">person_check</span>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-xl shadow p-5">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="font-black text-[#000b60] text-base leading-tight">Participaciones por sesión</h3>
                        <p class="text-xs text-gray-400 mt-0.5">Cantidad y promedio de calificación</p>
                    </div>
                    <span class="material-symbols-outlined text-[#000b60] opacity-20" style="font-size:28px">record_voice_over</span>
                </div>
                <div style="position:relative; height:230px;">
            ...
            <div class="bg-white rounded-xl shadow p-5">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="font-black text-[#000b60] text-base leading-tight">Calificaciones por tipo</h3>
                        <p class="text-xs text-gray-400 mt-0.5">Promedio por categoría de evaluación</p>
                    </div>
                    <span class="material-symbols-outlined text-[#000b60] opacity-20" style="font-size:28px">grading</span>
                </div>
                <div style="position:relative; height:230px;">
    ...
    <div class="bg-white rounded-xl shadow overflow-hidden">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h3 class="font-black text-[#000b60]">Sesiones recientes</h3>
            <a href="{{ route('sesiones.index') }}"
               class="text-xs text-[#000b60] font-semibold hover:underline flex items-center gap-0.5">
                Ver todas
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-[#f3faff] text-[#000b60]">
                    <tr>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-[#f3faff] transition">
                        <td class="px-6 py-3 font-semibold text-[#000b60]">
                        ...
                        <td class="px-4 py-3 text-center">
                            @if($sesion->finalizada)
                                <span class="bg-gray-100 text-gray-500 text-xs font-semibold px-2.5 py-1 rounded-full">Finalizada</span>
                            @else
    ...
    function renderAsistenciaEstudiante(d) {
        ...
        charts.ae = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    x: { beginAtZero: true, max: 100, ticks: { callback: function(v) { return v + '%'; } }, grid: { color: '#f3f4f6' } },
    ...
    function renderParticipaciones(d) {
        ...
        charts.part = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    y:  { beginAtZero: true, position: 'left',  ticks: { stepSize: 1 }, grid: { color: '#f3f4f6' } },
    ...
    function renderCalificaciones(d) {
        ...
        charts.cal = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    y: { beginAtZero: true, max: 10, ticks: { stepSize: 1 }, grid: { color: '#f3f4f6' } },
                    x: { grid: { display: false } }
                }
            }
        });
