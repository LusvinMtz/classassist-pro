...
>
    ...
    <div class="flex flex-wrap justify-between items-center gap-3 mb-5">
        ...
        <select wire:model.live="claseId"
                class="border border-gray-200 dark:border-[#2a3d4a] dark:bg-[#162a35] dark:text-[#dff4ff] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#000b60] min-w-[240px]">
    ...
    <div class="bg-white dark:bg-[#1e333c] rounded-xl shadow flex flex-col items-center justify-center py-32 text-gray-400 dark:text-gray-500">
        ...
        <p class="mt-4 font-semibold text-gray-500 dark:text-gray-400 text-xl">Selecciona una clase para gestionar calificaciones</p>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-[#162a35] border-b border-gray-100 dark:border-[#1a2f3c]">
                    <tr>
                        <th class="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs w-32">Carné</th>
                        <th class="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs">Nombre</th>
                        <th class="text-center px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs w-48">
                            Nota (0 – {{ $tipoActivo->punteo_max }})
                        </th>
                        <th class="text-center px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs w-28">%</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-50 dark:divide-[#1a2f3c]">
                    ...
                    <tr class="hover:bg-[#f3faff] dark:hover:bg-[#1a2f3c]">
                        <td class="px-5 py-3 font-mono text-xs text-[#000b60] dark:text-[#bcc2ff]">{{ $e->carnet }}</td>
        ...
        <div class="bg-white dark:bg-[#1e333c] rounded-xl shadow overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="text-sm" style="min-width: max-content; width: 100%;">
                    <thead class="bg-gray-50 dark:bg-[#162a35] border-b border-gray-100 dark:border-[#1a2f3c]">
                        <tr>
                            <th class="text-left px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs sticky left-0 bg-gray-50 dark:bg-[#162a35] min-w-[120px]">Carné</th>
                            <th class="text-left px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs sticky left-[120px] bg-gray-50 dark:bg-[#162a35] min-w-[200px]">Nombre</th>
                            @foreach($actividades as $act)
                            <th class="text-center px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs min-w-[140px]">
                                <p>{{ $act->nombre }}</p>
                                <p class="font-normal text-gray-400">(Max: {{ number_format($act->punteo_max, 0) }})</p>
                            </th>
                            @endforeach
                            <th class="text-center px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs min-w-[100px]">
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-[#1a2f3c]">
                        ...
                        <tr class="hover:bg-[#f3faff] dark:hover:bg-[#1a2f3c]">
                            ...
                            <td class="px-4 py-2.5 font-semibold sticky left-[120px] bg-white dark:bg-[#1e333c]">{{ $e->nombre }}</td>
                            @foreach($actividades as $act)
    ...
    <div class="bg-white dark:bg-[#1e333c] rounded-xl shadow overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="text-sm" style="min-width: max-content; width: 100%;">
                <thead class="bg-gray-50 dark:bg-[#162a35] border-b border-gray-100 dark:border-[#1a2f3c]">
                    <tr>
                        <th class="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs sticky left-0 bg-gray-50 dark:bg-[#162a35] min-w-[120px]">Carné</th>
                        <th class="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs sticky left-[120px] bg-gray-50 dark:bg-[#162a35] min-w-[200px]">Nombre</th>
                        @foreach($tipos as $tipo)
                        ...
                        @endforeach
                        <th class="text-center px-5 py-3 font-semibold text-gray-700 dark:text-gray-300 text-xs min-w-[120px] bg-blue-50 dark:bg-[#0d2535]">
                            TOTAL / 100
                        </th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-50 dark:divide-[#1a2f3c]">
                    ...
                    @endphp
                    <tr class="hover:bg-[#f3faff] dark:hover:bg-[#1a2f3c]">
                        <td class="px-5 py-3 font-mono text-xs text-[#000b60] dark:text-[#bcc2ff] sticky left-0 bg-white dark:bg-[#1e333c]">{{ $fila['carnet'] }}</td>
                        <td class="px-5 py-3 font-semibold sticky left-[120px] bg-white dark:bg-[#1e333c]">{{ $fila['nombre'] }}</td>
                        @foreach($tipos as $tipo)
                        @php
    ...
    <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-[#1e333c] rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
    ...
    <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
        <div class="bg-white dark:bg-[#1e333c] rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden">
